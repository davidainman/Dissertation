...
%I also attempted to elicit stories that would have a greater likelihood of illustrating serial verb or linker phenomenon, which meant settings of simultaneous action. This was not as successful as I had hoped, and I found instead that the best way to gather example constructions was through elicitation methods and gathering as much fluent text as possible. Anecdotally, staying in Nuuchahnulth for longer periods of time seemed to help more than anything else.
