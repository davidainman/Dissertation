...
\footnotetext{Compare SS ʔuʔuuyuk. TODO}
...
\footnotetext{The normal word for a seaserpent scale is č̓ipałmis (see \citealt{sapir1939} p.\ 281). However, Julia Lucas insists that it is č̓ip̓atmił.}
