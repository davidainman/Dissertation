...
\label{ch:clause}
\section{Syntactic Predication} \label{sec:predp}
...
\section{Participant Phrase} \label{sec:partp}
...
\section{Second-position clitics} \label{sec:cliticnormal}
...
\section{Clitics attaching to modifiers} \label{sec:cliticmodifier}
