...
\node (it2) at (4,0) {\textbf{Iterative II}};
...
[PredP \\ {\textit{head-comp-rule}}
 ...
 \avmbox{2} \[ \asort{adj-head} head & \[\asort{noun} prd & -- \] \]
            \end{avm}
    [Adj \\ \begin{avm}
 	 \[\asort{intransitive-verb-to-adj-rule} head.mod & \q< \avmbox{4} \q> \\
 	    subj & \q< \q> \]
     \end{avm}
     [ Verb \\ \begin{avm}
